...
class Pokemon(models.Model):
    ...
    title_en = models.CharField(max_length=200, blank=True, default='', verbose_name='по английски')
    title_jp = models.CharField(max_length=200, blank=True, default='', verbose_name='по японски')
    image = models.ImageField(upload_to='', null=True, blank=True, verbose_name='Изображение')
    description = models.TextField(blank=True, verbose_name='Описание')
    previous_evolution = models.ForeignKey("self", on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Из кого эвалюционировал')
